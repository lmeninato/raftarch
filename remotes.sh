...
# benchmark no failures
ssh va2083@apt175.apt.emulab.net "python3 raftarch/no_failures.py"
scp va2083@apt175.apt.emulab.net:~/no_failure.csv benchmarks_remote/with_txn_no_failure_2_clusters.csv

# benchmark with failures (including leader) at 10s
ssh va2083@apt175.apt.emulab.net "python3 raftarch/leader_failure.py"
scp va2083@apt175.apt.emulab.net:~/results_leader_failure.csv benchmarks_remote/with_txn_leader_failure_2_clusters.csv
